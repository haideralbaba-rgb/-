// ============================================================
// Vercel Serverless Function — Proxy آمن بين الـ Front-end وGoogle Gemini
// ============================================================
...
export default async function handler(req, res) {
  // CORS
  // نفس المصدر عادة، لكن نسمح بأي مصدر لتسهيل الاختبار
  ...
  try {
    ...
    const result = await callGemini(trimmedHistory);

    // في حال حدوث خطأ من Gemini
    if (result.error) {
